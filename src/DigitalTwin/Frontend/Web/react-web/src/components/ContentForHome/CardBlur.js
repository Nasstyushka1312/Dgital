...
function CardBlur() {
    const ContentForHome = [(<p style={{ fontSize: '17px', margin: '0px', fontFamily:'Roboto' }}>Digital Twin - это цифровой двойник вашего
        агропромышленного предприятия, позволяющий
        выполнять онлайн прогнозирование урожайности и различных ситуаций</p>)
        ,
        (<p style={{ fontSize: '12px', margin: '4em 0px', fontFamily: 'Open Sans'}}>Что-нибудь еще о том, какие мы хорошие,
            и почему нужно пользоваться нашим сервисом</p>),
        (<GroupTarif/>)
    ]
    return (
