...
{
    public class UpdateProductPrices : BackgroundService
    {
        ...
        public UpdateProductPrices(IServiceProvider serviceProvider, IConfiguration configuration, ILogger<UpdateProductPrices> logger)
        {
